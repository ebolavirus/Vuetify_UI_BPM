  ...
  <v-app>
    <v-app-bar app dark color="grey darken-2">
      ...
      <v-toolbar-items>
        ...
        <v-btn class="hidden-xs-only" text :input-value="shown === 'info'" @click="shown = 'info'"
          active-class="default-class grey darken-1">
          About
        </v-btn>
              ...
              <v-card width="500" height="295">
                ...
                <v-card-text>
                  <v-flex>
                    ...
                    <v-flex d-inline-flex ma-2>
                      <v-text-field v-model="defaults.cancelText" label="Cancel button label (cancelText)">
                      </v-text-field>
                    </v-flex>
                    <v-flex d-inline-flex ma-2>
                      <v-text-field v-model="defaults.acceptText" label="Accept button label (acceptText)">
                      </v-text-field>
                    </v-flex>
                    <v-flex d-inline-flex ma-2>
                      <v-text-field v-model="defaults.dialogMaxWidth" type="number" label="Max width (dialogMaxWidth)">
                      </v-text-field>
                    </v-flex>
                  </v-flex>
                </v-card-text>
